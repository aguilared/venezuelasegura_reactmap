...
class App extends Component {
  ...
  getData() {
    setTimeout(() => {
      ...
      Object.keys(this.state.homiPorParroquiasMes).map((key) => {
        this.setState.tothomiCachamay = this.state.homiPorParroquiasMes[key].mes_parr_cacha;
        this.setState.tothomiChirica = this.state.homiPorParroquiasMes[key].mes_parr_chi;
        this.setState.tothomiDallaCosta = this.state.homiPorParroquiasMes[key].mes_parr_dalla;
        this.setState.tothomiOncedeAbril = this.state.homiPorParroquiasMes[key].mes_parr_once;
        this.setState.tothomiPozoVerde = this.state.homiPorParroquiasMes[key].mes_parr_pozo;
        this.setState.tothomiSimonBolivar = this.state.homiPorParroquiasMes[key].mes_parr_simon;
        this.setState.tothomiUnare = this.state.homiPorParroquiasMes[key].mes_parr_unare;
        this.setState.tothomiUniversidad = this.state.homiPorParroquiasMes[key].mes_parr_uni;
        this.setState.tothomiVistaAlsol = this.state.homiPorParroquiasMes[key].mes_parr_vista;
        this.setState.tothomiYocoima = this.state.homiPorParroquiasMes[key].mes_parr_yoco;
        // console.log('Homicidios Cachamay = ' + tothomiCachamay);
        return (
          this.state.homiPorParroquiasMes[key].mes_parr_cacha
        );
      });
      ...
      this.setState({
        ...
        places: [
          ...
          },
          {
            ...
            position: { lat: 8.34, lng: -62.694726715 },
          },
          {
            name: 'Once de Abril',
            title: 'Once de Abril',
          ...
          },
          {
            ...
            position: { lat: 8.34955288448, lng: -62.6670885086 },
          },
          {
            name: 'Unare',
            title: 'Unare',
  ...
  async initialFetch() {
    ...
    //homiPorParroquiasMes = homiPorParroquiasMes
    //console.log('Homi del mes: '+homiPorParroquiasMes);
    this.setState({
      homiPorParroquiasMes,
      loading: false,

    });
    console.log('Homi del mes: ' +this.state.homiPorParroquiasMes[0]);
  }
